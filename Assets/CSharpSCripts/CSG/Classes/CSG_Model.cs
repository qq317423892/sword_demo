...
namespace Parabox.CSG
{
    ...
    public sealed class CSG_Model
    {
        ...
        public CSG_Model(GameObject gameObject)
        {
            ...
            Material[] mat = gameObject.GetComponent<MeshRenderer>().sharedMaterials;
            Transform tr = gameObject.GetComponent<Transform>();
            CSG_ModelInit(mesh, mat, tr);
        }

        /// <summary>
        /// Initialize a Model from a UnityEngine.Mesh and transform.
        /// </summary>
        public void CSG_ModelInit(Mesh mesh, Material[] materials, Transform transform)
        {
            if(mesh == null)
